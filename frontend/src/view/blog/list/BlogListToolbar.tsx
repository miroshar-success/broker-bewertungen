...
import destroyActions from 'src/modules/blog/destroy/blogDestroyActions';
import destroySelectors from 'src/modules/blog/destroy/blogDestroySelectors';
...
function BlogToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    blogSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    blogSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    blogSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/admin/audit-logs?entityNames=blog"

...
import actions from 'src/modules/pageWarning/importer/pageWarningImporterActions';
...
function PageWarningImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.pageWarning.importer.hint'),
  );
...
export default PageWarningImportPage;

...
function OpenxToolbar(props) {
  ...
  const hasPermissionToDestroy = useSelector(
    openxSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToCreate = useSelector(
    openxSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    openxSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/admin/audit-logs?entityNames=openx banner"

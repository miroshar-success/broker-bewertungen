...
import actions from 'src/modules/blogComment/importer/blogCommentImporterActions';
...
function BlogCommentImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.blogComment.importer.hint'),
  );
...
export default BlogCommentImportPage;

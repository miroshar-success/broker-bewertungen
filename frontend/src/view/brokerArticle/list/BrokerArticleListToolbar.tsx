...
function BrokerArticleToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    brokerArticleSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    brokerArticleSelectors.selectPermissionToImport,
  );
...
export default BrokerArticleToolbar;

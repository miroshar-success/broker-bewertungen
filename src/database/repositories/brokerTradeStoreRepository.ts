...
class BrokerTradeStoreRepository {
  ...
  static async create(data, options: IRepositoryOptions) {
    ...
    await options.database.broker_trade_store.create(
      {
  ...
  static async destroyByBroker(
    ...
    await options.database.broker_trade_store.destroy({
      where: {
        broker_id: id,
      },
      transaction,
  ...
  static async findAndCountAll(
    ...
    let { rows, count } =
      await options.database.broker_trade_store.findAndCountAll(
        {
          where,
          include,
...
export default BrokerTradeStoreRepository;

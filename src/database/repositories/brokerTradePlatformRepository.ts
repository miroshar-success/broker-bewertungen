...
class BrokerTradePlatformRepository {
  ...
  static async create(data, options: IRepositoryOptions) {
    ...
    await options.database.broker_trade_platform.create(
      {
  ...
  static async destroyByBroker(
    ...
    await options.database.broker_trade_platform.destroy({
      where: {
        broker_id: id,
      },
      transaction,
  ...
  static async findAndCountAll(
    ...
    let { rows, count } =
      await options.database.broker_trade_platform.findAndCountAll(
        {
          where,
          include,
...
export default BrokerTradePlatformRepository;
